...
public class RentCompanyEmbedded extends AbstractRentCompany implements Persistable {
    ...
    private double getProfitFromRecords(
        ...
        return records.mapToDouble(r -> getProfitFromRecord(r, modelName)).sum();
    }
                        ...
                        synchronized (carRecords) {
                            synchronized (returnedRecords) {
                                try (ObjectOutputStream output = new ObjectOutputStream(
                                    ...
                                    System.out.println("СОХРАНЕНИЕ ОТРАБОТАЛО");
                                } catch (Exception e) {
    ...
    public RentCompanyEmbedded restoreFromFile(String fileName) {
